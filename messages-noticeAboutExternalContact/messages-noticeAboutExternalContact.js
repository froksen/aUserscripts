...
(function() {
    ...
    function highlightEksternal(jNode)
    {
        ...
        $( ".subscriber" ).each(function() {
            ...
            var internalTitles = ['børnehaveklasseleder','sfo','tab','fysioterapeut','pædagogmedhjælper','skolepædagog','afdelingsleder',"lærer", "medarbejder", "leder",'pædagog',"ledelse",'teknisk/praktisk','lærervikar','vikar','afd.leder','skolesekretær','souschef','TAP','skoleleder','pædagogisk','pædagogiskassistent'];
